...
grafico_combinado_no2 <- ggplot(data=no2_mortalidad_completo_final, aes(x = CCAA, y = IDM, fill =`PM2.5 (μg/m3)`)) +
...
mrc_rec<-
  mrc_data %>%
  mutate(IDM=as.numeric(gsub("\\.","",IDM)))
>>>>>>> 35ec95befc28bd554b5529e23add30a7076905a1
...
```
##Ausencia de datos para los años 2011 y 2012
...
```
##Vuelve a haber ausencia de datos para el año 2011

##TABLA PM10 JUNTO CON DEFUNCIONES AÑOS 2010-2019
```{r, message=FALSE,warning=FALSE}
pm10_mortalidad_completo<-
  bind_rows(tabla_pm10_2010, tabla_pm10_2012, tabla_pm10_2013,  tabla_pm10_2014,  tabla_pm10_2015,  tabla_pm10_2016, tabla_pm10_2017,tabla_pm10_2018,tabla_pm10_2019) %>% 
  select(CCAA:`PM10 (μg/m3)`)
