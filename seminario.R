...
ggsave("grafico_combinado_no2.png", plot = grafico_combinado_no2_final, device = "png")
...
ggsave("grafico_combinado_pm10.png", plot = grafico_combinado_pm10_final, device = "png")
...
ggsave("grafico_combinado_pm2.5.png", plot = grafico_combinado_pm2.5, device = "png")
